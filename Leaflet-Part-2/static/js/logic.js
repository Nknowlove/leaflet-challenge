...
// Define baseMaps to hold the streetmap and topographic map layers.
let baseMaps = {
    "Street Map": street,
    "Topographic Map": topo
};

// Create the map object with a center and zoom level, and add the street map by default.
let myMap = L.map("map", {
    center: [27.96044, -82.30695],
    zoom: 7,
    layers: [street] // Default layer set to street map
});

// Add layer control to the map to switch between the two tile layers.
